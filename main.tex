...
\title{\textbf{SAUNAS}: III. The X-ray Scaling Relations of Diffuse Hot Gas Galactic Halos \footnote{Released on May, 11th, 2023}}
...
\begin{abstract}
Put the abstract here.  ANother sentence here.
...
%\sbsctn{a big mistake}
Here is a mistake. 

Wait, there is no mistake here anymore! 
...
\subsection{UnderMethods}
This sentence is in a subsection.

\subsubsection{Under-underMethods}
This sentence is in a sub sub section!

\subsection{another one}
Yep, we just made another one.

\subsubsection{new addition}
We just added another subsubsection
