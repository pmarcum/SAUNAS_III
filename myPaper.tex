...
%\documentclass[modern]{aastex631}  % I have a difficult time reviewing the paper in 2-column format. Feel free to %comment out when you need to. 
\documentclass[linenumbers,twocolumn,tighten,times]{aastex631}
%\documentclass[linenumbers, twocolumn,tighten,times]{aastex631} 
...
\begin{center}
 % trim left bottom right top 
% \includegraphics[trim={0 0 0 0}, clip, width=\textwidth]{FIGURES/NGC5084_spectra_regions.png} 
...
%\includegraphics[trim={60 0 60 0}, clip, width=\textwidth]{FIGURES/NGC5084_nodeco_psf_test.png} 
...
%\bibliography{do_NOT_manually_edit/bibFile}\bibliographystyle{aasjournal} 
\bibliography{pruned}\bibliographystyle{aasjournal}
