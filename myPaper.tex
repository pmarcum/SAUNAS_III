...
%%%%%%%%%%%%%%%%%%%%%%%% START THE DOCUMENT %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%!! The below puts a lightgrey "watermark" at top of manuscript to indicate compilation time. Comment out if not needed. 
\vspace*{-1.5cm}\noindent{\textcolor{lightgray}{Compiled: Monday, March 24, 2025 at 12:48 AM PDT}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%%%%%%%%%%%%%%%%%%%%%  TITLE ---------------------------
...
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%%%%%%%%%%%%%%%%%%%% AUTHORS ------------------------
...
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%\author[0000-0002-6610-2048]{Anton M. Koekemoer} 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%\affiliation{Space Telescope Science Institute, 3700 San Martin Dr., Baltimore, MD 21218, USA} 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%\author[0000-0001-5825-7683]{Kelly N. Sanderson} 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%\affiliation{Department of Astronomy, New Mexico State University, Las Cruces, NM, 88003, USA} 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%\affiliation{National Radio Astronomy Observatory, Domenici Science Operations Center, PO Box 0, Socorro, NM 87801, USA} 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
...
\affiliation{NASA Ames Research Center, Moffett Field, CA 94035, USA}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%%%%%%%%%%%%%%%%%%%%%%%% ABSTRACT --------------------------
\begin{abstract}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}Combining \Chandra, ALMA, EVLA, and \emph{Hubble} Space Telescope archival data  and newly acquired APO/DIS spectroscopy, we detect a double-lobed 17~kpc X-ray emission with plumes oriented approximately perpendicular and parallel to the galactic plane of the massive lenticular galaxy NGC\,5084 at 0.3--2.0~keV. 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}We detect a highly inclined ($i=71.2^{+1.8\circ}_{-1.7}$), molecular circumnuclear disk ($D=304^{+10}_{-11}$ pc) in the core of the galaxy rotating (V$^{\rm (2-1) CO}_{\rm rot}=242.7^{+9.6}_{-6.4}$ km s$^{-1}$) in a direction 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}perpendicular to that of the galactic disk, implying a total mass of $\log_{10}\left( \frac{M_{\rm BH}}{M_{\odot}} \right) = 7.66^{+0.21}_{-0.15}$ for NGC\,5084's supermassive black hole. Archival EVLA radio observations at 6 cm and 20 cm reveal two symmetric radio lobes aligned with the galactic plane, extending to a distance of $\overline{R}=4.6\pm0.6$ kpc from the core, oriented with the polar axis of the circumnuclear disk. The spectral energy distribution lacks strong emission lines in the optical range. 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}Three formation scenarios are considered to explain these multi-wavelength archival observations: 1) AGN re-orientation caused by accretion of surrounding material, 2) AGN-driven hot gas outflow directed along the 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}galactic minor axis, or 3) a starburst / supernovae driven outflow at the core of the galaxy. This discovery is enabled by new imaging analysis tools 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}including \SAUNAS\ (Selective Amplification of Ultra Noisy Astronomical Signal), demonstrating the abundance of information still to be exploited in the vast and growing astronomical archives.
\end{abstract}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%%%%%%%%%%%%%%%%%%%%%%%%%% KEYWORDS --------------------
\keywords{}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%%%%%%%%%%%%%%%%%%%%%%%%%% INTRODUCTION ----------------
\section{Introduction} \label{sec:intro}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}Observational evidence suggests that supermassive black holes (SMBHs; $M_{\rm BH}=10^{6-9.5}$) are present at the core of most massive galaxies \citep{kormendy+2013araa51_511}. The accretion of material by SMBHs has been observed to be tightly connected with the evolution of the entire galaxy, enabling periods of nuclear activity in which the total luminosity of the galaxy is enhanced. 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%"modified" does not imply a direction - the luminosity could increase or decrease. Active Galactic Nuclei \citep[AGNs,][]{mulchaey+1996apj467_197} are powered by the release of gravitational energy in a compact accretion disk surrounding the SMBH at the core of the galaxy, generating emission across the whole electromagnetic spectrum \citep{heckman+2014araa52_589}. 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}The main hypothesis of the unified scheme of active galactic nuclei (AGNs) is that the broad range of spectro-photometric properties is caused by the angle of inclination between the observer and an obstructing circumnuclear disk \citep{antonucci1993araa31_473, urry+1995pasp107_803}. The circumnuclear disk is a dusty and molecular gas component of outflowing and inflowing material surrounding the AGN, the so-called `torus'. According to this theory, when AGN's are observed at low inclination angles \citep[$i<45$--$60^{\circ}$, where $i=0^{\circ}$ would be face-on,][]{marin2014mnras441_551}, broad optical and ultraviolet (UV) spectral features (full width at half maximum; FWHM $\geq 1000-20,000$ km s$^{-1}$) are expected, corresponding to the Broad Line Region (BLR); a bright, non-stellar, central compact source visible at all wave-lengths, and with low polarization degree \citep[Type 1 AGNs,][]{netzer2015araa53_365}. At higher inclination angles, the BLR would be obscured by the torus showing only the narrow line region emission (NLR, Type 2 AGNs). See \citet{peterson2006incollection_77, netzer2015araa53_365, ramosalmeida+2017nat1_679} for reviews in the field.
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%! Studying AGNs are also important to address the origin of the Hubble sequence. 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}A large fraction of the total mass of SMBHs is thought to have been accreted during the peak of quasar activity in the early Universe \citep[$z=2-3$,][]{boyle+1998mnras293_49, delvecchio+2014mnras439_2736, madau+2014araa52_415}. During that period ($z\sim2-3$), the star-formation rate (SFR) and SMBH growth rate peaked and then decreased by a factor of ten from $z=1$ to the local Universe \citep{shankar+2009apj690_20}. The observed decrease in SFR is coincident with one of the most notable changes in the population of galaxies: the decline of the population of spirals and the rise of lenticular galaxies in the Local Universe \citep{dressler+1997apj490_577}.
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%The number density of spiral galaxies has decreased since $z\sim 1$ at the expense of the growing population of lenticular (S0) galaxies \citep{dressler+1997apj490_577}. As a consequence, S0s have become numerically dominant in the Local Universe \citep{bernardi+2010mnras404_2087}. Such evidence suggests that a significant fraction of S0s were spirals in the past, and that their star formation was suddenly shut down. S0 galaxies are thus a key piece in the challenge to understand the evolution of the Hubble diagram. 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}Lenticular galaxies seem to acquire their morphology by moving along multiple evolutionary paths 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}% the paratheses should not precede the list of possible formation mechanisms 
...
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}In this paper, we present previously undetected features likely related to the presence of an AGN in the edge-on supermassive lenticular galaxy NGC\,5084 \citep[$\alpha=200\fdg0705$, $\delta=-21\fdg8276$ ICRS, $D=	29.9\pm2.1$~Mpc, $z=0.005741$, 6.90~arcsec~kpc$^{-1}$,][Fig.\,\ref{fig:NGC5084_poster}]{gottesman+1986mnras219_759, devaucouleurs+1991book, koribalski+2004aj128_16} using optical and near-infrared (NIR) Hubble, Chandra X-ray, EVLA radio continuum, and ALMA observations. 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}NGC\,5084 is one of the most massive lenticular galaxies in the Local Universe \citep[]{ohlson+2024aj167_31}, with a total dynamical mass of approximately $1.3\times10^{12}$~M$_{\odot}$ \citep{koribalski+2004aj128_16} and a mass-to-light ratio $\Upsilon \geq 65$. Several features of this galaxy make it an interesting case study.
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\begin{figure*}[t!]
\begin{center}
...
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}The present work has revealed a collection of remarkable features in the massive lenticular galaxy NGC\,5084, including: 
\begin{enumerate}
...
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}The size ($D=304^{+10}_{-11}$ pc) and rotation speed ($V_{\rm rot} = 249.1^{+12.8}_{-9.6}$ km s$^{-1}$) of the circumnuclear disk detected with \emph{Hubble} and ALMA observations is compatible with the NLR dust disks that surround the AGN torus \citep[][]{ramosalmeida+2017nat1_679}. However, its perpendicular orientation to the rest of the galaxy poses an important question regarding its kinematic origin. \par 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}The presence of polar nuclear rings is a tracer of past accretion events in disk galaxies \citep{anantharamaiah+1996apj466_13}. Observations of these structures in NGC\,2685 and IC\,1689 revealed a stellar population different from that of the rest of the galaxy, suggesting the formation by an accretion event followed by a starburst \citep{silchenko1998aap330_412}. Surveys of galactic nuclear rings \citep{comeron+2010mnras402_2462} have also found that the distribution of position angles of nuclear rings shows no correlation with that of the rest of their host galaxies, supporting an accretion scenario for their formation. These findings indicate that the orientation of the inflow gas does not depend generally on the orientation of the host galaxy, but rather on the distribution of external material to be accreted. 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}Alternative mechanisms have been proposed to generate misaligned or even polar nuclear disks via galactic outflows without the need for gravitational interactions. Simulations have proven that star formation, supernovae, and AGN feedback can eject gas above the galactic plane \citep{emsellem+2015mnras446_2468, renaud+2015mnras454_3299}. Eventually this gas falls back to the core with a certain angular momentum, creating polar gas rings or disks \citep{combes2017inproceedings_Di}. In this scenario, the X-ray emission perpendicular to the disk observed in NGC\,5084 would be hot gas precipitating back into the core of the galaxy while cooling down, and then eventually transforming into the observed circumnuclear dust disk. However, despite NGC\,5084's extensive vertical X-ray emission, its HI emission does not show signs of filamentary structures expected with infall to the core of the galaxy  \citep{zheng+2022afz22_085004}, raising questions about this possibility.
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
...
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%%%%%%%%%%%%%%%%%%%%% ACKNOWLEDGEMENTS --------------------
...
\end{acknowledgments}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% To help institutions obtain information on the effectiveness of their
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% telescopes the AAS Journals has created a group of keywords for telescope 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% facilities. 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% Following the acknowledgments section, use the following syntax and the 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% \facility{} or \facilities{} macros to list the keywords of facilities used 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% in the research for the paper.  Each keyword is check against the master 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% list during copy editing.  Individual instruments can be provided in 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% parentheses, after the keyword, but they are not verified. 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%%%%%%%%%%%%%%%%%%%%%%% FACILITIES -------------------
\vspace{5mm}
\facilities{HST (WFPC2, WFC3), \Chandra\ (ACIS), ALMA, EVLA}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% Similar to \facility{}, there is the optional \software command to allow 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% authors a place to specify which programs were used during the creation of 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% the manuscript. Authors should list each code and include either a 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% citation or url to the code inside ()s when available. 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%%%%%%%%%%%%%%%%%%%%%%% SOFTWARE -----------------------
...
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% Appendix material should be preceded with a single \appendix command. 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% There should be a \section command for each appendix. Mark appendix 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% subsections with the same markup you use in the main body of the paper. 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% Each Appendix (indicated with \section) will be lettered A, B, C, etc. 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% The equation counter will reset when it encounters the \appendix 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% command and will number appendix equations (A1), (A2), etc. The 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% Figure and Table counter will not reset. 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%%%%%%%%%%%%%%%%%%%%%% APPENDIX ------------------------
\appendix
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\section{Extended X-ray Emission Detection Tests}
\label{Appendix:xray_tests}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}In this Appendix we expand on the technical aspects of \SAUNAS's \citep{borlaff+2024apj967_169} adaptively smoothed surface brightness maps (Sec.\,\ref{Appendix:xray_SNR}) for NGC\,5084. The quality checks described below provide additional verification of the detection of  extended X-ray emission in NGC\,5084, independent of both PSF deconvolution (Sec.\,\ref{Appendix:Xray_noPSFdeco_test}) and Voronoi binning (Sec.\,\ref{Appendix:Xray_novoro_test}).
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\subsection{Signal Detection in Extended Sources}
\label{Appendix:xray_SNR}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}One of the main advantages of \SAUNAS's spatial binning application to the X-ray event maps is the improvement in detectability of extended low surface brightness sources. Extended emission sensitivity limits in binned maps are considerably fainter than the reference point source sensitivity of \Chandra/ACIS\footnote{\Chandra/ACIS proposer guide: \url{https://cxc.harvard.edu/proposer/POG/html/chap6.html}} ($4\times10^{-15}$ erg cm$^{-2}$ s$^{-1}$ in 10$^4$ s, at 0.4--6.0 keV). In general, the sensitivity limit of \Chandra/ACIS ($f_{\rm lim}$) at a given signal-to-noise ratio ($\sigma$) detection level is a function of photon energy ($E$), binning area ($A$), exposure time ($t$), and equivalent effective area \citep[$M$, which has a complex variation with energy, see Fig.\,6 in][]{evans+2010apj189_37}:
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\begin{equation}
\label{eq:F_lim_Xray}
...
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}To test if the significance of the detected extended X-ray emission is independent of the processing methodology applied by \SAUNAS\ (PSF deconvolution, Voronoi binning), this section applies an alternative methodology widely used in extragalactic X-ray astronomy to detect extended sources: compare the radial emission profile of the target with that of the PSF of the instrument \citep{fabbiano+2017apj842_4,fabbiano+2018apj855_131, jones+2020apj891_133,ma+2020apj900_164,ma+2023apj948_61}. If a significant excess flux is detected above those predicted by the scaled PSF, then extended emission must be present in the source.
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}% put comment here
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}We simulate the \Chandra/ACIS PSF using the \texttt{MARX} software following the procedure described in the \ciao\ documentation\footnote{\ciao/\texttt{MARX}: \url{https://cxc.cfa.harvard.edu/ciao/threads/marx_sim/}}. The PSF takes into account the exact location of the source in the focal plane of ACIS, and the spectral energy distribution of the source as well The PSF generation process is also described in steps 4--6 of Sec.\,2.2.1 in \citet{borlaff+2024apj967_169}. To ensure that the PSF profile is well-sampled at high radii (associated with the outskirts of the galaxy, the region of interest), the generated PSF contains $3\times10^6$ events generated through multiple ray-tracing simulations (more than two orders of magnitude higher than all the events registered in the \Chandra/ACIS observations of NGC\,5084). This approach ensures that any potential excess of source counts compared with those of the PSF is not a false positive.
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}To generate the galaxy profile, all point sources (potentially associated with XRBs or background quasars) are removed similar to \SAUNAS's approach, with the exception of the core of the galaxy which, given its role as the main contributor to the scattered light emission, is left intact. Finally, the PSF central surface brightness profile is scaled to the central surface brightness of the observed galaxy, comparing their radial variation of surface brightness.
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}The results are shown in Fig.\,\ref{fig:NGC5084_psf_profile}. The left panel shows the broadband ($0.3-2.0$ keV) \Chandra/ACIS X-ray flux map as generated by the \ciao\ pipeline, demonstrating signs of potential extended emission. No PSF deconvolution or adaptive smoothing was applied in this image. In the right panel, the surface brightness profile of the broadband X-ray flux is compared to the scaled PSF of the \Chandra/ACIS observations at the position of NGC\,5084. The \Chandra/ACIS PSF at the observational setup of NGC\,5084 has a FWHM of 1.1".
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}Compared to the PSF and the background, we detect a $>>3\sigma$ excess of X-ray emission up to a radial distance of $\sim90$ arcsec from the core in the observations of NGC\,5084. Between 25-90 arcsec, the PSF scattered light is two orders of magnitude dimmer than the detected extended emission of NGC\,5084. The radial limit of the profile is compatible with the $3\sigma$ radial limit of the emission detected by \SAUNAS\ (see Sec.\,\ref{subsec:results_xray_ima}).
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}The test presented in this section demonstrates three important points:
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\begin{enumerate}
...
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}Figure \ref{fig:NGC5084_per_band} shows the X-ray mosaics in the individual bands (\emph{soft:} 0.3-1.0 keV, \emph{medium:} 1.0-2.0 keV, \emph{hard:} 2.0 - 8.0 keV) processed with \texttt{SAUNAS I} \citep{borlaff+2024apj967_169}.
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\begin{figure*}[t!]
\begin{center}
 % trim left bottom right top 
...
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}Figure \ref{fig:NGC5084_multiband} shows the emission in each individual HST band analyzed in Sec.\,\ref{subsec:results_hst}, including the F658N - F702W color image. 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\begin{figure*}[]
\begin{center}
 % trim left bottom right top 
...
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}In this section we show the optical spectral energy distribution of the inner regions of NGC\,5084, as obtained by the 6dF Galaxy Survey \citep{jones+2004mnras355_747}. The spectral range covered is 4000-7500 $\AA$. The observations used an aperture of $R=6.7$ arcsec around the core of the galaxy. 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%%%%%%%%%%%%%%%%%%%%%%%% BIBLIOGRAPHY ----------------
\bibliography{Extragalactic}\bibliographystyle{CORE-AAS/aasjournal}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% This command is needed to show the entire author+affiliation list when 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% the collaboration and author truncation commands are used.  It has to 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% go at the end of the manuscript. 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%\allauthors 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% Include this line if you are using the \added, \replaced, \deleted 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%% commands to see a summary list of all changes at the end of the article. 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}%\listofchanges 
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\raisebox{0.90em}{\scalebox{0.01}{\transparent{1.0}.\the\inputlineno.}}
\end{document}
